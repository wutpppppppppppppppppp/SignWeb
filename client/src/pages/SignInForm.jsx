  ...
  return (
    <div className="w-screen h-screen flex flex-col justify-between ">
      ...
      <div className=" flex flex-col items-center justify-center">
        <div className="text-lg font-bold mb-4 ">ข้อมูลส่วนตัว</div>
        <div className="flex flex-wrap justify-start gap-4 max-w-l ">
      ...
      {/* Section 2: Training */}
      <div className="flex flex-col items-center justify-center">
        <div className="text-lg font-bold mb-4">การฝึกอบรม</div>
        <div className="flex flex-wrap justify-center gap-4 max-w-l">
          <select className="select select-bordered flex items-center gap-2 ">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="text-lg font-bold mb-4">การลงทะเบียน</div>
        <div className="flex flex-wrap gap-4 max-w-s ">
          <label className="input input-bordered flex items-center gap-2 ">
            <span className="whitespace-nowrap">อีเมล</span>
            <input type="text" className="grow" placeholder="test@gmail.com" />
          </label>
          <div className="flex flex-wrap gap-4 max-w-xs w-full">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="text-lg font-bold mb-4">การยืนยันตัวตน</div>
        <div className="flex justify-center gap-4 max-w-l w-full px-4">
